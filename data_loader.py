...
def load_data(dataset_name, image_size_before_crop,
    ...
    inputs['image_i'] = tf.image.resize_images(
        inputs['image_i'], [image_size_before_crop, image_size_before_crop], method=tf.image.ResizeMethod.BILINEAR)
    inputs['image_j'] = tf.image.resize_images(
        inputs['image_j'], [image_size_before_crop, image_size_before_crop], method=tf.image.ResizeMethod.BILINEAR)
